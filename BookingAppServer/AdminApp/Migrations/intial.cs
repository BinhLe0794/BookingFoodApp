...
public partial class intial : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            {
                Id = table.Column<string>("varchar(50)", false, 50, nullable: false),
                Fullname = table.Column<string>("nvarchar(255)", maxLength: 255, nullable: false),
                RefreshToken = table.Column<string>("nvarchar(max)", nullable: true),
                RefreshTokenExpiryTime = table.Column<DateTime>("datetime2", nullable: true),
                LastLogin = table.Column<DateTime>("datetime2", nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            table => new
            {
                ...
                RoleId = table.Column<string>("varchar(50)", nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            table => new
            {
                ...
                AccountId = table.Column<string>("varchar(50)", nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            table => new
            {
                Id = table.Column<int>("int", nullable: false)
                    .Annotation("SqlServer:Identity", "1, 1"),
                UserId = table.Column<string>("varchar(50)", nullable: false),
                ClaimType = table.Column<string>("nvarchar(max)", nullable: true),
                ClaimValue = table.Column<string>("nvarchar(max)", nullable: true)
            },
            constraints: table =>
        ...
        migrationBuilder.CreateTable(
            ...
            table => new
            {
                ...
                Name = table.Column<string>("nvarchar(500)", maxLength: 500, nullable: false),
                Description = table.Column<string>("nvarchar(500)", maxLength: 500, nullable: false),
                Calorie = table.Column<int>("int", nullable: false),
                Price = table.Column<double>("float", nullable: false),
                ImageUrl = table.Column<string>("nvarchar(max)", nullable: false),
                CreatedAt = table.Column<DateTime>("datetime2", nullable: false),
                ModifiedAt = table.Column<DateTime>("datetime2", nullable: true),
                OrderId = table.Column<Guid>("uniqueidentifier", nullable: true)
            },
            constraints: table =>
            {
