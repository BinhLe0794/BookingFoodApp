    ...
    public class OrderController : ControllerBase
    {
        ...
        public async Task<IActionResult> CheckoutOrder([FromBody] CheckoutOrderRequest request)
        {
            try
            {
                ...
                if (resultOrder <= 0)
                {
                    return BadRequest(new ApiErrorResult<bool>("Checkout failed"));
                }
                ...
                if (result <= 0)
                {
                    return BadRequest(new ApiErrorResult<bool>("Checkout Order Failed"));
                }
        ...
        public async Task<IActionResult> GetOrdersByUser([FromQuery] string userId)
        {
            try
            {
                ...
                {
                    return BadRequest(new ApiErrorResult<bool>("user is invalid"));
                }
        ...
        public async Task<IActionResult> GetOrderDetail(string orderId)
        {
            try
            {
                ...
                {
                    return BadRequest(new ApiErrorResult<bool>("Check your orderId"));
                }
