/**
 * This method will add an existing `dt-tag tr` element to a DataTable. This
 * can
 ...
 * this ability built in, and extend it to be able to use jQuery objects as
 * well
 ...
 *  @param {boolean} [bRedraw=false] Indicate if the table should do a redraw
 *     or not.
 *
 *  @example
