...
(function (factory) {
    ...
    $.extend(RowGroup.prototype, {
         ...
         * rows. This is basically a bootstrap for the self iterative _group
         * and _groupDisplay methods
         * @private
         */
        _draw: function () {
            var dt = this.s.dt;
         ...
         * @param {DataTables.Api} rows API of the rows to consider for this
         *     group
         * @returns {object[]} Nested grouping information - it is structured
         *     like this:
         *    {
         *		dataPoint: 'Edinburgh',
         *		rows: [ 1,2,3,4,5,6,7 ],
        ...
        /**
         * Take a rendered value from an end user and make it suitable for
         * display as a row, by wrapping it in a row, or detecting that it is a
         * row.
