...
(function (factory) {
    ...
    DataTable.ext.renderer.pageButton.bulma = function (settings,
                                                        host,
                                                        idx,
                                                        buttons,
                                                        page,
    ...
    $(document).on('init.dt', function (e, ctx) {
        ...
        // ).removeClass('input').addClass('form'); $( 'div.dataTables_filter
        // input', api.table().container() ).wrap( '<span class="ui input" />'
        // );
    });
